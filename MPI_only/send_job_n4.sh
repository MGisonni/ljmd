...
#SBATCH --job-name=04n_MPI_alt      		# The name of your job, you'll se it in squeue.
...
# cd examples
cd build/examples
mpirun -np 4 ../ljmd.x 20 < argon_108.inp 
mpirun -np 4 ../ljmd.x 20 < argon_2916.inp  
mpirun -np 4 ../ljmd.x 20 < argon_78732.inp  
