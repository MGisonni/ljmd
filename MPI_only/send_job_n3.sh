...
#SBATCH --job-name=03n_MPI_alt      		# The name of your job, you'll se it in squeue.
...
#SBATCH --ntasks=3                   # Number of MPI ranks (1 for MPI serial job)
...
# cd examples
cd build/examples
mpirun -np 3 ../ljmd.x 20 < argon_108.inp 
mpirun -np 3 ../ljmd.x 20 < argon_2916.inp  
mpirun -np 3 ../ljmd.x 20 < argon_78732.inp  
