...
#SBATCH --job-name=02n_MPI_bal      		# The name of your job, you'll se it in squeue.
...
#SBATCH --ntasks=2                   # Number of MPI ranks (1 for MPI serial job)
...
# cd examples
cd build/examples
mpirun -np 2 ../ljmd.x 20 < argon_108.inp 
mpirun -np 2 ../ljmd.x 20 < argon_2916.inp  
mpirun -np 2 ../ljmd.x 20 < argon_78732.inp  
